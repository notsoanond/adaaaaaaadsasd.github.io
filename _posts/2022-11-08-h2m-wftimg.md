...
***UPDATE: Flashpoint Core isn't a thing anymore. Please use Flashpoint Infinity with Curation features instead.***
...
A pack with the files for the game and the template can be downloaded [here](/assets/wftimg/wftimg.zip).

If you want to use another program to edit the spritesheet which supports layers, a pack with the template spritesheet as individual PNGs can be downloaded [here](/assets/wftimg/template.zip). Make sure that this program supports making images without antialiasing.
...
<div align="center">
    <img src="/assets/wftimg/LayerDifference.png" width="800" />
</div>
...
<div align="center">
    <img src="/assets/wftimg/Layers1-2.png" width="800" />
</div>
...
- Original game (reuploaded because yes) <br>[[Play]](/assets/wftimg/index.html)
- Character changed to "Veronica" from [[CM] EDM Festival 2](https://www.deviantart.com/bo-the-sno/art/CM-EDM-Festival-2-866517884) <br>[[Play]](/assets/wftimg/index-Veronica.html)
- Character changed to the Goth from [Sizing Up](https://www.deviantart.com/bo-the-sno/art/Sizing-Up-798058676) <br>[[Play]](/assets/wftimg/index-Goth.html)
- Character changed to "Alleigha" from [[CM] Bar Balloon](https://www.deviantart.com/bo-the-sno/art/CM-Bar-Balloon-794324531) <br>[[Play]](/assets/wftimg/index-Alleigha.html)
